...
This is a very simple example of a **logical argument**. Propositions may also be composed of multiple **atomic propositions** joined by **connectives**. Each atomic proposition must be a valid proposition that can be evaluated as True or False in isolation, for example (connectives in *bold):
