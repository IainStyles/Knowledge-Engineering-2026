...
2. The premises and the conclusion must be true. If this is the case, *and* the argument is valid, then the argument is said to be **sound**

Notice that soundness requires validity.
